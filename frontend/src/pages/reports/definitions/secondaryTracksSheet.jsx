...
const secondaryTracksSheet = {
  ...
  excelFileName: () => 'كشف مسارات البكالوريا والثانوية العامة.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف حصر وتوزيع طلاب مسارات الثانوية العامة والبكالوريا</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-SECONDARY-TRACKS-SHEET</div>
          </div>
        </div>
...
export default secondaryTracksSheet;
