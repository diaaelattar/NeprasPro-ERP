...
const seatingNumbersList = {
  ...
  excelFileName: () => 'كشف أرقام الجلوس وتوزيع اللجان (12 د).xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف أرقام الجلوس المعتمدة وتوزيع لجان الامتحانات (سجل 12 د)</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-SEATING-NUMBERS-LIST</div>
          </div>
        </div>
