...
const outstandingStudentsRegister = {
  ...
  excelFileName: () => 'سجل الطلاب الفائقين والموهوبين.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">سجل حصر ورعاية الطلاب الموهوبين والفائقين علمياً ورياضياً</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-OUTSTANDING-STUDENTS-REGISTER</div>
          </div>
        </div>
