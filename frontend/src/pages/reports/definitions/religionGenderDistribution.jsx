...
const religionGenderDistribution = {
  ...
  excelFileName: () => 'كشف تصنيف الطلاب حسب الديانة والنوع.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف الإحصاء التفصيلي لطلاب المدرسة حسب الديانة والنوع</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-RELIGION-GENDER-DISTRIBUTION</div>
          </div>
        </div>
