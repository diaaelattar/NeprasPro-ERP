...
const emergencyPhonesList = {
  ...
  excelFileName: () => 'سجل هواتف ولي الأمر والطوارئ.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">سجل حصر بيانات أسر الطلاب وهواتف الاتصال في الطوارئ</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-EMERGENCY-PHONES-LIST</div>
          </div>
        </div>
