...
const parentStaffAffiliation = {
  ...
  excelFileName: () => 'سجل حصر أبناء العاملين بالتربية والتعليم.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">سجل حصر الطلاب من أبناء العاملين بوزارة التربية والتعليم</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-PARENT-STAFF-AFFILIATION</div>
          </div>
        </div>
