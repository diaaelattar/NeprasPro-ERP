...
const martyrsChildren = {
  ...
  excelFileName: () => 'سجل حصر أبناء الشهداء ومصابي العمليات.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">سجل حصر الطلاب من أبناء الشهداء ومصابي العمليات</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-MARTYRS-CHILDREN</div>
          </div>
        </div>
