...
const committeeDistributionList = {
  ...
  excelFileName: () => 'كشف توزيع الطلاب على مقار اللجان الامتحانية.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف توزيع الطلاب وأرقام الجلوس على لجان الاختبارات</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-COMMITTEE-DISTRIBUTION-LIST</div>
          </div>
        </div>
...
export default committeeDistributionList;
