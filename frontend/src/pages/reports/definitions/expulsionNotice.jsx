...
const expulsionNotice = {
  ...
  excelFileName: () => 'إشعار فصل طالب وتنبيه إعادة القيد.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">إشعار قرار فصل طالب لتجاوز نسبة الغياب المقررة قانوناً</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-EXPULSION-NOTICE</div>
          </div>
        </div>
...
export default expulsionNotice;
