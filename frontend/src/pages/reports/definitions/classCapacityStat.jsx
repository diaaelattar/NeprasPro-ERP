...
const classCapacityStat = {
  ...
  excelFileName: () => 'إحصاء السعة الاستيعابية للفصول والكثافة.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">تقرير مؤشرات الكثافة الدراسية والسعة الاستيعابية للفصول</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-CLASS-CAPACITY-STAT</div>
          </div>
        </div>
