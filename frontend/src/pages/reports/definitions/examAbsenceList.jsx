...
const examAbsenceList = {
  ...
  excelFileName: () => 'كشف حصر غياب الامتحانات اليومي.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف ومحضر حصر الطلاب الغائبين باللجان الامتحانية</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-EXAM-ABSENCE-LIST</div>
          </div>
        </div>
...
export default examAbsenceList;
