...
const medicalExemptionList = {
  ...
  excelFileName: () => 'كشف الإعفاء الطبي والتربية الرياضية.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف حصر الطلاب المعفين من التربية الرياضية بقرارات طبية معتمدة</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-MEDICAL-EXEMPTION-LIST</div>
          </div>
        </div>
...
export default medicalExemptionList;
