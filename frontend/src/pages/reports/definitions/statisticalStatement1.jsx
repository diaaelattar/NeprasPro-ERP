...
const statisticalStatement1 = {
  ...
  excelFileName: () => 'البيان الإحصائي العام للمدرسة (بيان 1).xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">البيان الإحصائي الموحد لإجمالي أعداد الطلاب والمراحل (بيان 1)</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-STATISTICAL-STATEMENT-1</div>
          </div>
        </div>
