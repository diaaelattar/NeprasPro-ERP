...
const secondLanguageSheet = {
  ...
  excelFileName: () => 'كشف توزيع اللغة الأجنبية الثانية.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">كشف حصر وتوزيع الطلاب حسب اللغة الأجنبية الثانية</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-SECOND-LANGUAGE-SHEET</div>
          </div>
        </div>
