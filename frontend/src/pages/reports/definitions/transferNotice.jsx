...
const transferNotice = {
  ...
  excelFileName: () => 'إشعار وموافقة نقل طالب إلى مدرسة أخرى.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">نموذج إشعار وموافقة نقل طالب وإخلاء طرف مدرسي</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-TRANSFER-NOTICE</div>
          </div>
        </div>
