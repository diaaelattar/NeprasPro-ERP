...
const guardianSummonsNotice = {
  ...
  excelFileName: () => 'إشعار استدعاء ولي أمر طالب رسمي.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">نموذج إشعار استدعاء رسمى لولي أمر الطالب</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-GUARDIAN-SUMMONS-NOTICE</div>
          </div>
        </div>
...
export default guardianSummonsNotice;
