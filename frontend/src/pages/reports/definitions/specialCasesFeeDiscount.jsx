...
const specialCasesFeeDiscount = {
  ...
  excelFileName: () => 'سجل الحالات المستحقة لخصومات المصروفات.xlsx',
      ...
      <div className="report-page-printable">
        <div className="report-official-header">
          ...
          <div className="header-col-center">
            <h2 className="report-title-main">سجل حصر الحالات الخاصة والمستحقين للإعفاءات والخصومات المدرسية</h2>
          ...
          <div className="header-col-left">
            ...
            <div>كود التقرير: NEP-SPECIAL-CASES-FEE-DISCOUNT</div>
          </div>
        </div>
