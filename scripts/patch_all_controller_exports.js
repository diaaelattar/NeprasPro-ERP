...
// Ensure excelReportEngine is required
...
// 2. New clean exportFullClassListExcel
...
if (oldTemplateStart !== -1 && oldTemplateEnd !== -1) {
  ...
  console.log('✅ exportExcelTemplate replaced!');
}
...
if (oldFullStart !== -1 && oldFullEnd !== -1) {
  ...
  console.log('✅ exportFullClassListExcel replaced!');
}

fs.writeFileSync(filePath, content, 'utf8');
console.log('✅ students.controller.js fully updated!');
