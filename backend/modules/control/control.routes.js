...
router.post('/update-pin',             controlController.updateMasterPin);
...
router.post('/calculate-term',          controlController.recalculateTermResults);
router.post('/calculate-final',         controlController.recalculateFinalResults);
router.get('/results-summary',          controlController.getResultsSummary);
router.get('/evaluation-components',    controlController.getEvaluationComponents);
router.get('/rating-scale',             controlController.getRatingScale);
router.post('/open-reports-folder',      controlController.openReportsFolder);
router.post('/export-report-pdf',       controlController.exportReportPdf);
