...
const _seedLookupData = (dbInstance) => {
  ...
  try {
    ...
    const administrations = [
      ...
      // الجيزة
      ['GIZ',['إدارة الجيزة التعليمية','إدارة العمرانية','إدارة الهرم','إدارة بولاق الدكرور','إدارة العجوزة','إدارة شمال الجيزة','إدارة جنوب الجيزة','إدارة الدقي','إدارة الوراق','إدارة أوسيم','إدارة كرداسة','إدارة منشأة القناطر','إدارة البدرشين','إدارة العياط','إدارة الحوامدية','إدارة أبو النمرس','إدارة الصف','إدارة أطفيح','إدارة أكتوبر','إدارة الشيخ زايد','إدارة حدائق أكتوبر','إدارة الواحات البحرية']],
      // الإسكندرية
      ['ALX',['إدارة الإسكندرية التعليمية الأولى','إدارة الإسكندرية التعليمية الثانية','إدارة المنتزه','إدارة العامرية','إدارة برج العرب']],
      // الشرقية
      ['SHR',['إدارة الزقازيق','إدارة بلبيس','إدارة منيا القمح','إدارة أبوحماد','إدارة القنايات','إدارة فاقوس','إدارة العاشر من رمضان']],
      // الدقهلية
      ['DKH',['إدارة المنصورة الأولى','إدارة المنصورة الثانية','إدارة ميت غمر','إدارة طلخا','إدارة شربين','إدارة دكرنس','إدارة السنبلاوين']],
      // الغربية
